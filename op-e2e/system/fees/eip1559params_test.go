...
func TestEIP1559Params(t *testing.T) {
	...
	expectedElasticity := uint32(2) // gas target will be 15_000_000
	...
	eip1559.DecodeHoloceneExtraData(h.Extra)
	...
	delta := ((15_000_000 - int64(h.GasUsed)) * h.BaseFee.Int64() / 15_000_000 / int64(expectedDenom))
	...
	eip1559.DecodeHoloceneExtraData(b.Header().Extra)
